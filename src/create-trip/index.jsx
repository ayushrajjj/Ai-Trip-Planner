...
function CreateTrip() {
  ...
  const OnGenerateTrip = async () => {
    ...
    if (!formdata.noOfdays || formdata.noOfdays > 10 || !formdata.location || !formdata.budget || !formdata.traveler) {
  ...
  return (
    <div className="sm:px-10 md:px-32 lg:px-56 xl:px-10 px-5 mt-10">
      <h2 className="font-bold text-3xl text-center">Tell Your Preferences 🚗 ✈️ 🌴</h2>
      ...
      <div>
        ...
        <Input
          ...
          max={10}
          min={1}
          onChange={(e) => handleInputChange("noOfdays", parseInt(e.target.value, 10))}
        />
      </div>
      ...
      <div className="my-10 flex justify-end">
        <Button onClick={OnGenerateTrip}>Generate Trip Plan</Button>
      </div>
